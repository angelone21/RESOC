...
public class VistaPrincipal extends javax.swing.JFrame {
    ...
    private void bt_crearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_crearActionPerformed
        try {
            // TODO add your handling code here:
            Icon icon = label_imagen.getIcon();
            BufferedImage imagen = new BufferedImage(icon.getIconWidth(), icon.getIconHeight(), BufferedImage.TYPE_INT_RGB);
            ByteArrayOutputStream b = new ByteArrayOutputStream();
            ImageIO.write(imagen, "jpg", b);
            byte[] bytesImagen = b.toByteArray();
            Publicacion publicacion = new Publicacion(perfilAutenticado.getIdusario(), area_texto.getText(), bytesImagen, null, box_tipoPublicacion.getSelectedItem().toString(), 0, 0);
